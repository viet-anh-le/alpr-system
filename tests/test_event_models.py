"""Tests for the MonitorEvent / EventVehicle Pydantic models."""
...
from api.database.models import EventVehicle, MonitorEvent


@pytest.mark.unit
def test_event_vehicle_minimal_construction():
    v = EventVehicle(
        track_id=7,
...
@pytest.mark.unit
def test_event_default_status_and_lists():
...
@pytest.mark.unit
def test_event_rejects_bad_source_type():
    now = datetime.now(timezone.utc)
