...
function DashboardPage() {
    ...
    const [preprocessedPreviewFrame, setPreprocessedPreviewFrame] =
        useState(null);
    ...
    const rejectedList = Object.values(rejectedVehicles).sort(
        (a, b) => a.id - b.id,
    );
            ...
            <div className="grid w-full max-w-5xl gap-5 lg:grid-cols-[1.05fr_0.95fr] lg:items-stretch">
                <section className="surface-panel overflow-hidden p-6 sm:p-8">
                    ...
                    <h1 className="mt-3 max-w-xl text-3xl font-bold leading-tight text-[var(--color-text)]">
                        {isRegister
                            ? "Tạo tài khoản hệ thống ALPR"
                            : "Đăng nhập hệ thống ALPR Việt Nam"}
                    </h1>
                    ...
                    <div className="mt-8 grid gap-3 sm:grid-cols-3">
                        ...
                        <AuthMetric
                            value="CSRF"
                            label="Ghi dữ liệu có bảo vệ"
                        />
                        <AuthMetric value="DB" label="Lịch sử kết quả" />
                    </div>
                </section>
...
function AuthMetric({ value, label }) {
    return (
        <div className="rounded-xl border border-[var(--color-border)] bg-black/15 p-3">
            <div className="data-font text-lg font-bold text-cyan-100">
                {value}
            </div>
    ...
    return (
        <BrowserRouter>
            <Routes>
                ...
                <Route
                    path="/login"
                    element={<PublicAuthRoute mode="login" />}
                />
                <Route
                    path="/register"
                    element={<PublicAuthRoute mode="register" />}
                />
                <Route
                    path="/dashboard"
                    element={
